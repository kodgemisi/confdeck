...
EmailTemplateType.create({
                             ...
                             default_body: "Your application is accepted for {{ conference.name }} <br /><br/>
                <b>Speakers:</b> <br/>
                <ul>
...
EmailTemplateType.create({
                             ...
                             default_body: "Your application is rejected for {{ conference.name }} <br /><br/>
            <b>Speakers:</b> <br/>
            <ul>
             {% for speaker in speech.speakers %}
...
EmailTemplateType.create({
                             ...
                             default_body: "Your application is received for {{ conference.name }} <br /><br/>
            <b>Speakers:</b> <br/>
            <ul>
             {% for speaker in speech.speakers %}
...
EmailTemplateType.create({
                             ...
                             default_body: "New application is received for {{ conference.name }} <br /><br/>
            <b>Speakers:</b> <br/>
            <ul>
             {% for speaker in speech.speakers %}
