...
function renderPagination(wizard, options, state)
{
    if (options.enablePagination)
    {
        var pagination = "<{0} class=\"actions {1}\"><ul role=\"menu\" aria-label=\"{2}\">{3}</ul></{0}>",
            buttonTemplate = "<li><a href=\"#{0}\" role=\"menuitem\" class=\"btn btn-default\">{1}</a></li>",
            buttonTemplateFinish = "<li><a href=\"#{0}\" role=\"menuitem\" class=\"btn btn-primary\">{1}</a></li>",
            //buttonTemplateFinish = "<li><button type=\"submit\" role=\"menuitem\" class=\"btn btn-primary finish\">{1}</button></li>",
            buttons = "";
        ...
        {
            buttons += format(buttonTemplateFinish, "finish", options.labels.finish);
        }
