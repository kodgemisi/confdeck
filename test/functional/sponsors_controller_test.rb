...
class SponsorsControllerTest < ActionController::TestCase
  ...
  test "should create sponsor" do
    assert_difference('Sponsor.count') do
      post :create, sponsor: { conference_id: @sponsor.conference_id, name: @sponsor.name, website: @sponsor.website }
    end
  ...
  test "should update sponsor" do
    put :update, id: @sponsor, sponsor: { conference_id: @sponsor.conference_id, name: @sponsor.name, website: @sponsor.website }
    assert_redirected_to sponsor_path(assigns(:sponsor))
  end
